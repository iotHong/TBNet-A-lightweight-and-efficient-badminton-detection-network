...
if __name__ == '__main__':
    ...
    if 1:
        ...
        origin_imgs = F.interpolate(torch.from_numpy(resized_imgs).unsqueeze(0).float(), (720, 1280))
        ...
        resized_imgs = resized_imgs.transpose(1, 2, 0)
        print('resized_imgs shape: {}'.format(resized_imgs.shape))
        origin_imgs = cv2.resize(resized_imgs, (1280, 720))
    ...
    for i in range(configs.num_frames_sequence):
        ...
        axes[i].set_title('image {}'.format(i))
    fig.suptitle(
        'Event: is land {}, is hitnet: {}, is shot: {}, ball_position_xy: (x= {}, y= {})'.format(target_event[0], target_event[1],target_event[2],
